...
class FontSizesViewController: UITableViewController {
    var font: UIFont! //To be set by parent view controller on segue
    ...
    override func viewDidLoad() {
        ...
        tableView.estimatedRowHeight = FontSizesViewController.pointSizes[0] //cells will now automatically stretch to proper height
